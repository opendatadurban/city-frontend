...
import { getComponentNames } from '@city-frontend/lib/components'
import { filterPath, getListing } from '@city-frontend/lib/files'
import {
...
export default async () => {
  const srcPath = join(packageNameToPath('city-frontend'), 'src')
  ...
  return {
    ...
    assets: ['/dist/city/assets', '/dist/city/city-frontend.min.js.map'],
    sass: ['/dist/city-prototype-kit/init.scss'],
    scripts: [
      {
