...
describe('Radios', () => {
  ...
  it('render example with minimum required name and items', () => {
    ...
    const $component = $('.city-radios')

    const $firstInput = $component.find('.city-radios__item:first-child input')
    const $firstLabel = $component.find('.city-radios__item:first-child label')
    expect($firstInput.attr('name')).toBe('example-default')
    expect($firstInput.val()).toBe('yes')
    expect($firstLabel.text()).toContain('Yes')

    const $lastInput = $component.find('.city-radios__item:last-child input')
    const $lastLabel = $component.find('.city-radios__item:last-child label')
  ...
  it('renders without falsy items', () => {
    ...
    const $component = $('.city-radios')
    const $items = $component.find('.city-radios__item input')
  ...
  it('render classes', () => {
    ...
    expect($component.hasClass('city-radios--inline')).toBeTruthy()
  })
  ...
  describe('items', () => {
    it('render a matching label and input using name by default', () => {
      ...
      const $firstInput = $component.find(
        '.city-radios__item:first-child input'
      )
      const $firstLabel = $component.find(
        '.city-radios__item:first-child label'
      )
    ...
    it('allows item.checked to override value', () => {
      ...
      const $green = $('.city-radios').find('input[value="green"]')
    ...
    describe('when they include attributes', () => {
      it('renders the attributes', () => {
        ...
        const $lastInput = $component.find(
          '.city-radios__item:last-child input'
        )
    ...
    describe('when they include a hint', () => {
      it('renders the hint text', () => {
        ...
        expect($('.city-radios__hint').text()).toContain(
      ...
      it('renders the correct id attribute for the hint', () => {
        ...
        expect($('.city-radios__hint').attr('id')).toBe('gateway-item-hint')
      })

      it('the input describedBy attribute matches the item hint id', () => {
        const $ = render('radios', examples['with hints on items'])

        expect($('.city-radios__input').attr('aria-describedby')).toBe(
          'gateway-item-hint'
        )
      })
    })
    ...
    describe('render conditionals', () => {
      it('hidden by default when not checked', () => {
        ...
        const $hiddenConditional = $component
          .find('.city-radios__conditional')
          .first()
        expect($hiddenConditional.text()).toContain('Email address')
        expect(
          $hiddenConditional.hasClass('city-radios__conditional--hidden')
        ).toBeTruthy()
      })
      ...
      it('visible when checked because of checkedValue', () => {
        ...
        const $conditional = $('.city-radios__conditional').last()
        expect($conditional.text()).toContain('Mobile phone number')
        expect(
          $conditional.hasClass('city-radios__conditional--hidden')
        ).toBeFalsy()
      })
      ...
      it('visible by default when checked', () => {
        ...
        expect(
          $visibleConditional.hasClass('city-radios__conditional--hidden')
        ).toBeFalsy()
      })
      ...
      it('with association to the input they are controlled by', () => {
        ...
        const $firstInput = $component.find('.city-radios__input').first()
      ...
      it('omits empty conditionals', () => {
        ...
        const $component = $('.city-radios')
        expect($component.find('.city-radios__conditional')).toHaveLength(0)
      })

      it('does not associate radios with empty conditionals', () => {
        const $ = render('radios', examples['with empty conditional'])

        const $input = $('.city-radios__input').first()
    ...
    it('render divider', () => {
      ...
      const $component = $('.city-radios')
      const $divider = $component.find('.city-radios__divider')
    ...
    it('render additional label classes', () => {
      ...
      const $component = $('.city-radios')
      const $label = $component.find('.city-radios__item label')
  ...
  describe('when they include an error message', () => {
    ...
    it('uses the idPrefix for the error message id if provided', () => {
      ...
      const $errorMessage = $('.city-error-message')
  ...
  describe('nested dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.city-form-group > .city-fieldset > .city-radios')
    ...
    it('passes through label params without breaking', () => {
      ...
      expect(htmlWithClassName($, '.city-radios__label')).toMatchSnapshot()
    })
