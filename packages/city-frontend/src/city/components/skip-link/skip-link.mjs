 ...
 * @preserve
 */
export class SkipLink extends cityFrontendComponent {
  /** @private */
  $module
  ...
  constructor($module) {
    ...
    this.$module.addEventListener('click', () =>
      setFocus($linkedElement, {
        onBeforeFocus() {
          $linkedElement.classList.add('city-skip-link-focused-element')
        },
        onBlur() {
          $linkedElement.classList.remove('city-skip-link-focused-element')
        }
      })
    )
  }
   ...
   */
  static moduleName = 'city-skip-link'
}
