...
describe('header', () => {
  ...
  describe('custom options', () => {
    ...
    it('renders custom container classes', () => {
      ...
      const $component = $('.city-header')
      const $container = $component.find('.city-header__container')

      expect(
        $container.hasClass('city-header__container--full-width')
      ).toBeTruthy()
    })
    ...
    it('renders custom navigation classes', () => {
      ...
      const $component = $('.city-header')
      const $container = $component.find('.city-header__navigation')

      expect($container.hasClass('city-header__navigation--end')).toBeTruthy()
    })
    ...
    it('renders home page URL', () => {
      ...
      const $component = $('.city-header')
      const $homepageLink = $component.find('.city-header__link--homepage')
  ...
  describe('with product name', () => {
    it('renders product name', () => {
      ...
      const $component = $('.city-header')
      const $productName = $component.find('.city-header__product-name')
  ...
  describe('with service name', () => {
    it('renders service name', () => {
      ...
      const $component = $('.city-header')
      const $serviceName = $component.find('.city-header__service-name')
  ...
  describe('with navigation', () => {
    it('renders navigation', () => {
      ...
      const $component = $('.city-header')
      const $list = $component.find('ul.city-header__navigation-list')
      const $items = $list.find('li.city-header__navigation-item')
      const $firstItem = $items.find('a.city-header__link:first-child')
    ...
    it('renders navigation label and menu button text when these are both set', () => {
      ...
      const $component = $('.city-header')
      const $nav = $component.find('nav')
      const $button = $component.find('.city-header__menu-button')
    ...
    it('renders navigation with active item', () => {
      ...
      const $activeItem = $('li.city-header__navigation-item:first-child')
      expect(
        $activeItem.hasClass('city-header__navigation-item--active')
      ).toBeTruthy()
    })
    ...
    it('allows navigation item text to be passed whilst escaping HTML entities', () => {
      ...
      const $navigationLink = $('.city-header__navigation-item a')
    ...
    it('renders navigation item with text without a link', () => {
      ...
      const $navigationItem = $('.city-header__navigation-item')
    ...
    describe('menu button', () => {
      it('has an explicit type="button" so it does not act as a submit button', () => {
        ...
        const $button = $('.city-header__menu-button')
  ...
  describe.each([
    ...
    it('does not include a menu button', async () => {
      expect($('.city-header__menu-button')).toHaveLength(0)
    })
    ...
    it('does not include a city-header__content wrapper', async () => {
      expect($('.city-header__content')).toHaveLength(0)
    })
  })
