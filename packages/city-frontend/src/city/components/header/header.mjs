 ...
 * @preserve
 */
export class Header extends cityFrontendComponent {
  /** @private */
  $module
  ...
  constructor($module) {
    ...
    this.$module = $module
    const $menuButton = $module.querySelector('.city-js-header-toggle')
    ...
    if (!menuId) {
      throw new ElementError({
        componentName: 'Header',
        identifier:
          'Navigation button (`<button class="city-js-header-toggle">`) attribute (`aria-controls`)'
      })
    }
