...
describe('Inset text', () => {
  ...
  describe('by default', () => {
    it('renders with classes', () => {
      ...
      const $component = $('.city-inset-text')
      expect(
    ...
    it('allows HTML to be passed un-escaped', () => {
      ...
      const mainContent = $('.city-inset-text .city-body:first-child')
        .text()
        .trim()

      const warningContent = $('.city-inset-text .city-warning-text__text')
        .text()
        .trim()
