...
describe('Cookie Banner', () => {
  ...
  describe('question banner', () => {
    it('renders a heading', () => {
      ...
      const $heading = $('.city-cookie-banner__heading')
    ...
    it('renders main content text', () => {
      ...
      const $content = $('.city-cookie-banner__content')
    ...
    it('renders main content html', () => {
      ...
      expect($content.html().trim()).toBe(
        '<p class="city-body">We use cookies in <span>our service</span>.</p>'
      )
    })
    ...
    it('renders classes', () => {
      ...
      const $banner = $('.city-cookie-banner .city-cookie-banner__message')
  ...
  describe('role and aria attributes', () => {
    it('has a role of region', () => {
      ...
      const $component = $('.city-cookie-banner')
  ...
  describe('confirmation banner', () => {
    it('role alert not set by default', () => {
      ...
      const $component = $('.city-cookie-banner')
      const $banner = $component.find('.city-cookie-banner__message')
    ...
    it('hides banner if hidden option set to true', () => {
      ...
      const $component = $('.city-cookie-banner__message')
  ...
  describe('action', () => {
    it('renders as button by default', () => {
      ...
      const $actions = $('.city-cookie-banner .city-button')
    ...
    it('renders as a link if href provided', () => {
      ...
      const $actions = $('.city-cookie-banner .city-link')
    ...
    it('renders button with additional classes', () => {
      ...
      expect($actions.attr('class')).toBe(
        'city-button my-button-class app-button-class'
      )
    })
    ...
    it('renders link with additional classes', () => {
      ...
      const $actions = $('.city-cookie-banner .city-link')
      expect($actions.attr('class')).toBe(
        'city-link my-link-class app-link-class'
      )
    })
  ...
  describe('client-side implementation example', () => {
    it('renders 3 banners', () => {
      ...
      const $actions = $('.city-cookie-banner__message')
    ...
    it('2 banners are hidden', () => {
      ...
      const $actions = $('.city-cookie-banner__message[hidden]')
    ...
    it('has a data-nosnippet attribute to hide it from search result snippets', () => {
      ...
      const $parentContainer = $('.city-cookie-banner')
  ...
  describe('full cookie banner hidden', () => {
    it('HTML for 3 banners is present', () => {
      ...
      const $messages = $('.city-cookie-banner__message')
    ...
    it('parent banner is hidden', () => {
      ...
      const $cookieBanner = $('.city-cookie-banner[hidden]')
    ...
    it('adds classes to parent container when provided', () => {
      ...
      const $cookieBanner = $('.city-cookie-banner')
