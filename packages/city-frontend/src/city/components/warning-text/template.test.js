...
describe('Warning text', () => {
  ...
  describe('default example', () => {
    it('renders with text', () => {
      ...
      const $component = $('.city-warning-text')
    ...
    it('renders with default assistive text', () => {
      ...
      const $assistiveText = $('.city-visually-hidden')
    ...
    it('hides the icon from screen readers using the aria-hidden attribute', () => {
      ...
      const $icon = $('.city-warning-text__icon')
  ...
  describe('custom options', () => {
    it('renders classes', () => {
      ...
      const $component = $('.city-warning-text')
      expect(
        $component.hasClass('city-warning-text--custom-class')
      ).toBeTruthy()
    })
