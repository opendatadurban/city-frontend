...
describe('Date input', () => {
  ...
  describe('default example', () => {
    it('renders with id', () => {
      ...
      const $component = $('.city-date-input')
    ...
    it('renders default inputs', () => {
      ...
      const $items = $('.city-date-input__item')
    ...
    it('renders item with capitalised label text', () => {
      ...
      const $firstItems = $('.city-date-input__item:first-child')
    ...
    it('renders inputs with type="text"', () => {
      ...
      const $firstInput = $('.city-date-input__item:first-child input')
    ...
    it('renders item with implicit class for label', () => {
      ...
      const $firstItems = $('.city-date-input__item:first-child label')
      expect($firstItems.hasClass('city-date-input__label')).toBeTruthy()
    })

    it('renders item with implicit class for input', () => {
      const $ = render('date-input', examples.default)

      const $firstItems = $('.city-date-input__item:first-child input')
      expect($firstItems.hasClass('city-date-input__input')).toBeTruthy()
    })
  ...
  describe('items', () => {
    ...
    it('renders with default items', () => {
      ...
      const $firstItemInput = $(
        '.city-date-input:first-child .city-date-input__input'
      )
    ...
    it('renders items with value', () => {
      ...
      const $lastItems = $('.city-date-input__item:last-child input')
  ...
  describe('custom options', () => {
    ...
    it('renders with item attributes', () => {
      ...
      const $input1 = $('.city-date-input__item:nth-of-type(1) input')
      const $input2 = $('.city-date-input__item:nth-of-type(2) input')
      const $input3 = $('.city-date-input__item:nth-of-type(3) input')
  ...
  describe('nested dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $(
        '.city-form-group > .city-fieldset > .city-date-input'
      )
    ...
    it('passes through label params without breaking', () => {
      ...
      expect(htmlWithClassName($, '.city-date-input__label')).toMatchSnapshot()
    })
