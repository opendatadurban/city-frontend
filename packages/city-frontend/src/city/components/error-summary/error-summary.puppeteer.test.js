...
describe('Error Summary', () => {
  ...
  it('adds the tabindex attribute on page load', async () => {
    ...
    const tabindex = await page.$eval('.city-error-summary', (el) =>
  ...
  it('is automatically focused when the page loads', async () => {
    ...
    expect(moduleName).toBe('city-error-summary')
  })
  ...
  describe('when auto-focus is disabled', () => {
    describe('using data-attributes', () => {
      ...
      it('does not focus on page load', async () => {
        ...
        expect(activeElement).not.toBe('city-error-summary')
      })
    })
  ...
  describe.each(inputTypes)(
    ...
    (_, inputId, legendOrLabelSelector) => {
      ...
      beforeAll(async () => {
        ...
        await page.click(`.city-error-summary a[href="#${inputId}"]`)
      })
      ...
      await expect(
        render(page, 'error-summary', examples.default, {
          beforeInitialisation($module) {
            ...
            $module.outerHTML = `<svg data-module="city-error-summary"></svg>`
          }
        })
      ).rejects.toMatchObject({
        cause: {
