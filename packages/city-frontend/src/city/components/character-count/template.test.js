...
describe('Character count', () => {
  ...
  describe('default example', () => {
    it('renders with id', () => {
      ...
      const $component = $('.city-js-character-count')
  ...
  describe('custom options', () => {
    ...
    it('renders with formGroup', () => {
      ...
      const $component = $('.city-form-group')
      expect(
        $component.hasClass('app-character-count--custom-modifier')
      ).toBeTruthy()
    })
  ...
  describe('count message', () => {
    it('renders with the amount of characters expected', () => {
      ...
      const $countMessage = $('.city-character-count__message')
    ...
    it('is associated with the textarea', () => {
      ...
      const $textarea = $('.city-js-character-count')
      const countMessageId = $('.city-character-count__message').attr('id')
  ...
  describe('when it has the spellcheck attribute', () => {
    it('renders the textarea with spellcheck attribute set to true', () => {
      ...
      const $component = $('.city-character-count .city-textarea')
  ...
  describe('when it includes an error message', () => {
    ...
    it('adds the error class to the character-count', () => {
      ...
      const $component = $('.city-js-character-count')
      expect($component.hasClass('city-textarea--error')).toBeTruthy()
    })
  ...
  describe('with dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.city-form-group > .city-js-character-count')
  ...
  describe('with threshold', () => {
    it('hides the count to start with', () => {
      ...
      const $component = $('.city-character-count')
  ...
  describe('with custom textarea description', () => {
    it('allows customisation of the textarea description', () => {
      ...
      const message = $('.city-character-count__message').text().trim()
