 ...
 *
 * Tracks the number of characters or words in the `.city-js-character-count`
 ...
 * @preserve
 */
export class CharacterCount extends cityFrontendComponent {
  /** @private */
  $module
  ...
  constructor($module, config = {}) {
    ...
    const $textarea = $module.querySelector('.city-js-character-count')
    if (
      !(
      ...
      throw new ElementError({
        ...
        identifier: 'Form field (`.city-js-character-count`)'
      })
    }
    ...
    $screenReaderCountMessage.className =
      'city-character-count__sr-status city-visually-hidden'
    ...
    $visibleCountMessage.classList.add('city-character-count__status')
    $visibleCountMessage.setAttribute('aria-hidden', 'true')
    this.$visibleCountMessage = $visibleCountMessage
    $textareaDescription.insertAdjacentElement('afterend', $visibleCountMessage)

    // Hide the textarea description
    $textareaDescription.classList.add('city-visually-hidden')
  ...
  updateVisibleCountMessage() {
    ...
    this.$visibleCountMessage.classList.toggle(
      'city-character-count__message--disabled',
      !this.isOverThreshold()
    )

    // Update styles
    this.$textarea.classList.toggle('city-textarea--error', isError)
    this.$visibleCountMessage.classList.toggle('city-error-message', isError)
    this.$visibleCountMessage.classList.toggle('city-hint', !isError)
   ...
   */
  static moduleName = 'city-character-count'
 ...
 *   messages](https://frontend.design-system.service.gov.uk/localise-city-frontend).
