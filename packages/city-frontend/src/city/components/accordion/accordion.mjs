import { cityFrontendComponent } from '../../city-frontend-component.mjs'
 ...
 * @preserve
 */
export class Accordion extends cityFrontendComponent {
  /** @private */
  $module
  ...
  /** @private */
  controlsClass = 'city-accordion__controls'

  /** @private */
  showAllClass = 'city-accordion__show-all'

  /** @private */
  showAllTextClass = 'city-accordion__show-all-text'

  /** @private */
  sectionClass = 'city-accordion__section'

  /** @private */
  sectionExpandedClass = 'city-accordion__section--expanded'

  /** @private */
  sectionButtonClass = 'city-accordion__section-button'

  /** @private */
  sectionHeaderClass = 'city-accordion__section-header'

  /** @private */
  sectionHeadingClass = 'city-accordion__section-heading'

  /** @private */
  sectionHeadingDividerClass = 'city-accordion__section-heading-divider'

  /** @private */
  sectionHeadingTextClass = 'city-accordion__section-heading-text'

  /** @private */
  sectionHeadingTextFocusClass = 'city-accordion__section-heading-text-focus'

  /** @private */
  sectionShowHideToggleClass = 'city-accordion__section-toggle'

  /** @private */
  sectionShowHideToggleFocusClass = 'city-accordion__section-toggle-focus'

  /** @private */
  sectionShowHideTextClass = 'city-accordion__section-toggle-text'

  /** @private */
  upChevronIconClass = 'city-accordion-nav__chevron'

  /** @private */
  downChevronIconClass = 'city-accordion-nav__chevron--down'

  /** @private */
  sectionSummaryClass = 'city-accordion__section-summary'

  /** @private */
  sectionSummaryFocusClass = 'city-accordion__section-summary-focus'

  /** @private */
  sectionContentClass = 'city-accordion__section-content'
   ...
   * https://github.com/alphagov/city-frontend/issues/2327#issuecomment-922957442
   *
   * @private
   ...
   */
  static moduleName = 'city-accordion'
