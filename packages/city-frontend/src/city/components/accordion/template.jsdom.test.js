...
describe('Accordion', () => {
  ...
  describe('default example', () => {
    ...
    it('renders with content as text, wrapped in styled paragraph', () => {
      ...
      expect($paragraph).toHaveClass('city-body')
    ...
    it('renders with content as html', () => {
      const $componentContent = document.querySelector(
        '.city-accordion__section:last-child .city-accordion__section-content'
      )
    ...
    it('renders with id', () => {
      const $component = document.querySelector('.city-accordion')
  ...
  describe('custom options', () => {
    ...
    it('renders with specified heading level', () => {
      ...
      const $componentHeading = document.querySelector(
        '.city-accordion__section-heading'
      )
    ...
    it('renders with section expanded class', () => {
      ...
      const $componentSection = document.querySelector(
        '.city-accordion__section'
      )

      expect($componentSection).toHaveClass('city-accordion__section--expanded')
    })
    ...
    it('renders with summary', () => {
      ...
      const $componentSummary = document.querySelector(
        '.city-accordion__section-summary'
      )
    ...
    it('renders list without falsy values', () => {
      ...
      const $sections = document.querySelectorAll('.city-accordion__section')
