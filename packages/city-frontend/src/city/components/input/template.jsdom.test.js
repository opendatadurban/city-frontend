...
describe('Input', () => {
  ...
  describe('default example', () => {
    ...
    beforeAll(() => {
      ...
      $component = document.querySelector('.city-input')
      $label = document.querySelector('.city-label')
    })
    ...
    it('includes a form group wrapper', () => {
      const $formGroup = document.querySelector('.city-form-group')
    ...
    it('does not include the input wrapper', () => {
      const $wrapper = document.querySelector(
        '.city-form-group > .city-input__wrapper'
      )
  ...
  describe('custom options', () => {
    it('includes additional classes from the `classes` option', () => {
      ...
      const $component = document.querySelector('.city-input')
  ...
  describe('when a hint is passed', () => {
    ...
    beforeAll(() => {
      ...
      $component = document.querySelector('.city-input')
      $hint = document.querySelector('.city-hint')
    })
  ...
  describe('when an error message is passed', () => {
    ...
    beforeAll(() => {
      ...
      $component = document.querySelector('.city-input')
      $errorMessage = document.querySelector('.city-error-message')
    })
    ...
    it('includes the error modifier class on the input', () => {
      expect($component).toHaveClass('city-input--error')
    })

    it('includes the error modifier class on the form group wrapper', () => {
      const $formGroup = document.querySelector('.city-form-group')

      expect($formGroup).toHaveClass('city-form-group--error')
    })
  })
  ...
  describe('when it includes a prefix', () => {
    ...
    beforeAll(() => {
      ...
      $wrapper = document.querySelector('.city-input__wrapper')
      $prefix = document.querySelector('.city-input__prefix')
    })
    ...
    it('escapes HTML entities when using the `text` option', () => {
      ...
      const $prefix = document.querySelector('.city-input__prefix')
  ...
  describe('when it includes a suffix', () => {
    ...
    beforeAll(() => {
      ...
      $wrapper = document.querySelector('.city-input__wrapper')
      $suffix = document.querySelector('.city-input__suffix')
    })
    ...
    it('escapes HTML entities when using the `text` option', () => {
      ...
      const $suffix = document.querySelector('.city-input__suffix')
  ...
  describe('when it includes both a prefix and a suffix', () => {
    it('renders the prefix before the suffix', () => {
      ...
      expect(
        document.querySelector('.city-input__prefix ~ .city-input__suffix')
      ).toBeInTheDocument()
    })
  })
