const { render, goTo } = require('@city-frontend/helpers/puppeteer')
const { getExamples } = require('@city-frontend/lib/components')

const inputSelector = '.city-js-password-input-input'
const buttonSelector = '.city-js-password-input-toggle'
const statusSelector = '.city-password-input__sr-status'
          ...
          await expect(
            render(page, 'password-input', examples.default, {
              beforeInitialisation($module) {
                ...
                $module.outerHTML = `<svg data-module="city-password-input"></svg>`
              }
            })
          ).rejects.toMatchObject({
            cause: {
        ...
        it('throws when the input element is missing', async () => {
          await expect(
            ...
            cause: {
              name: 'ElementError',
              message:
                'Password input: Form field (`.city-js-password-input-input`) not found'
            }
          })
        })
        ...
        it('throws when the input is not an <input> element', async () => {
          await expect(
            render(page, 'password-input', examples.default, {
              beforeInitialisation($module, { selector }) {
                ...
                $module.querySelector(selector).outerHTML =
                  '<textarea class="city-js-password-input-input"></textarea>'
              },
              context: {
                selector: inputSelector
              }
            ...
            cause: {
              name: 'ElementError',
              message:
                'Password input: Form field (`.city-js-password-input-input`) is not of type HTMLInputElement'
            }
          })
        })
        ...
        it('throws when the input is not a `password` type', async () => {
          await expect(
            ...
            cause: {
              name: 'ElementError',
              message:
                'Password input: Form field (`.city-js-password-input-input`) must be of type `password`.'
            }
          })
        })
        ...
        it('throws when the button is missing', async () => {
          await expect(
            ...
            cause: {
              name: 'ElementError',
              message:
                'Password input: Button (`.city-js-password-input-toggle`) not found'
            }
          })
        })
          ...
          await expect(
            render(page, 'password-input', examples.default, {
              beforeInitialisation($module, { selector }) {
                ...
                $module.querySelector(selector).outerHTML =
                  '<div class="city-js-password-input-toggle"></div>'
              },
              context: {
                selector: buttonSelector
              }
            ...
            cause: {
              name: 'ElementError',
              message:
                'Password input: Button (`.city-js-password-input-toggle`) is not of type HTMLButtonElement'
            }
          })
        })
        ...
        it('throws when the button is not a `button` type', async () => {
          await expect(
            ...
            cause: {
              name: 'ElementError',
              message:
                'Password input: Button (`.city-js-password-input-toggle`) must be of type `button`.'
            }
          })
        })
      })
