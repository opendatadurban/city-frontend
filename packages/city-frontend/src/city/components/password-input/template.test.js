...
describe('Password input', () => {
  ...
  describe('default example', () => {
    ...
    it('renders with the input wrapper', () => {
      ...
      const $wrapper = $('.city-form-group > .city-input__wrapper')
    ...
    describe('toggle button', () => {
      it('renders with the toggle button', () => {
        ...
        const $button = $(
          '.city-form-group > .city-input__wrapper > .city-button'
        )
        expect($button.length).toBeTruthy()
        expect($button.hasClass('city-button--secondary')).toBeTruthy()
      })
