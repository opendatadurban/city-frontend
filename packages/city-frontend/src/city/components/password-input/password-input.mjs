 ...
 * @preserve
 */
export class PasswordInput extends cityFrontendComponent {
  /** @private */
  $module
  ...
  constructor($module, config = {}) {
    ...
    const $input = $module.querySelector('.city-js-password-input-input')
    if (!($input instanceof HTMLInputElement)) {
      throw new ElementError({
        componentName: 'Password input',
        element: $input,
        expectedType: 'HTMLInputElement',
        identifier: 'Form field (`.city-js-password-input-input`)'
      })
    }
    ...
    if (!($showHideButton instanceof HTMLButtonElement)) {
      throw new ElementError({
        ...
        identifier: 'Button (`.city-js-password-input-toggle`)'
      })
    }
    ...
    $screenReaderStatusMessage.className =
      'city-password-input__sr-status city-visually-hidden'
   ...
   */
  static moduleName = 'city-password-input'
