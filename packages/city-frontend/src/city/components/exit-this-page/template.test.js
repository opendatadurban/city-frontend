...
describe('Exit this page', () => {
  ...
  describe('default example', () => {
    it('renders the default example', () => {
      ...
      const $button = $('.city-exit-this-page').find('.city-button')

      expect($button.hasClass('city-button--warning')).toBeTruthy()
      expect($button.html()).toContain(
        '<span class="city-visually-hidden">Emergency</span> Exit this page'
      )
  ...
  describe('Custom options', () => {
    ...
    it('renders with a custom id', () => {
      const $ = render('exit-this-page', examples.testing)
      const $component = $('.city-exit-this-page')
