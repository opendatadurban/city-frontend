 ...
 * @preserve
 */
export class Checkboxes extends cityFrontendComponent {
  /** @private */
  $module
  ...
  syncConditionalRevealWithInputState($input) {
    ...
    if ($target?.classList.contains('city-checkboxes__conditional')) {
      const inputIsChecked = $input.checked

      $input.setAttribute('aria-expanded', inputIsChecked.toString())
      $target.classList.toggle(
        'city-checkboxes__conditional--hidden',
        !inputIsChecked
      )
    }
  }
   ...
   */
  static moduleName = 'city-checkboxes'
}
