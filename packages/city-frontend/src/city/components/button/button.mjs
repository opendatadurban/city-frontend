 ...
 * @preserve
 */
export class Button extends cityFrontendComponent {
  /** @private */
  $module
   ...
   * native HTML buttons.
   *
   * See https://github.com/alphagov/city_elements/pull/272#issuecomment-233028270
   *
   * @private
