...
describe('Breadcrumbs', () => {
  ...
  describe('default example', () => {
    ...
    beforeAll(() => {
      ...
      $component = document.querySelector('.city-breadcrumbs')
      $list = document.querySelector('ol.city-breadcrumbs__list')
      $listItems = document.querySelectorAll('li.city-breadcrumbs__list-item')
    })
    ...
    describe.each([
      ...
      ({ index, expectedText, expectedHref }) => {
        ...
        it(`includes a link with the class city-breadcrumbs__link`, () => {
  ...
  describe('when the last breadcrumb is the current page', () => {
    ...
    beforeAll(() => {
      ...
      $lastItem = document.querySelector(
        '.city-breadcrumbs__list-item:last-child'
      )
    })
  ...
  describe('custom options', () => {
    it('escapes HTML when using the `text` option', () => {
      ...
      const $item = document.querySelector('.city-breadcrumbs__list-item')
    ...
    it('escapes HTML when using the `text` option without a link', () => {
      ...
      const $item = document.querySelector(
        '.city-breadcrumbs__list-item:nth-child(2)'
      )
    ...
    it('sets any additional attributes on the link based on the `item.attributes` option', () => {
      ...
      const $breadcrumbLink = document.querySelector('.city-breadcrumbs__link')
    ...
    it('includes additional classes from the `classes` option', () => {
      ...
      const $component = document.querySelector('.city-breadcrumbs')
    ...
    it('adds the `--collapse-on-mobile` modifier class if `collapseOnMobile` is true', () => {
      ...
      const $component = document.querySelector('.city-breadcrumbs')
      expect($component).toHaveClass('city-breadcrumbs--collapse-on-mobile')
    })
