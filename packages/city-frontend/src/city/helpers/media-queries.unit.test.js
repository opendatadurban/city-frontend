...
describe('@mixin city-media-query', () => {
  ...
  it('allows you to target min-width using a predefined breakpoint', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($from: mobile) {
          color: red;
        }
      }
    `
  ...
  it('allows you to target max-width using a numeric value', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($until: 20em) {
          color: red;
        }
      }
    `
  ...
  it('allows you to target max-width using a predefined breakpoint', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($until: desktop) {
          color: red;
        }
      }
    `
  ...
  it('allows you to target combined min-width and max-width using numeric values', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($from: 20em, $until: 40em) {
          color: red;
        }
      }
    `
  ...
  it('allows you to target combined min-width and max-width using predefined breakpoints', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($from: mobile, $until: tablet) {
          color: red;
        }
      }
    `
  ...
  it('allows you to target using custom directives', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($until: 40em, $and: '(orientation: landscape)') {
          color: red;
        }
      }
    `
  ...
  it('allows you to target particular media types', async () => {
    const sass = `
      ...
      .foo {
        @include city-media-query($until: 40em, $media-type: 'aural') {
          color: red;
        }
      }
    `
