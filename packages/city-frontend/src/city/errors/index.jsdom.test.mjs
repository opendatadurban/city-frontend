import { ElementError, cityFrontendError, SupportError } from './index.mjs'

describe('errors', () => {
  describe('cityFrontendError', () => {
  ...
  describe('SupportError', () => {
    ...
    it('is an instance of cityFrontendError', () => {
      expect(new SupportError(document.body)).toBeInstanceOf(cityFrontendError)
    })
  ...
  describe('ElementError', () => {
    it('is an instance of cityFrontendError', () => {
      ...
      ).toBeInstanceOf(cityFrontendError)
    })
    it('has its own name set', () => {
      expect(
        new ElementError({
