...
You can include JavaScript for all components by copying both `city-frontend.min.js` and `city-frontend.min.js.map` from `node_modules/city-frontend/dist/city/` into your application and referencing the JavaScript directly:
...
- [watch the city-frontend Github repository](https://help.github.com/en/articles/watching-and-unwatching-repositories)
- join the [#city-design-system channel on cross-government Slack](https://ukgovernmentdigital.slack.com/app_redirect?channel=city-design-system)
