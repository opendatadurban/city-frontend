...
import { filterPath, getDirectories, hasPath } from '@city-frontend/lib/files'
 ...
 * @property {import('@city-frontend/lib/components').ComponentFixtures} componentFixtures - All Component fixtures
 * @property {import('@city-frontend/lib/components').ComponentFixture} [componentFixture] - Single component fixture
