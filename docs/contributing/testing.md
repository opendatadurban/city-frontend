...
1. Open `packages/city-frontend/src/city/components/<COMPONENT>/<COMPONENT>.yaml`, where `<COMPONENT>` is the component you've changed.
2. Add or update examples in the `examples` list.

If you've created a new component, create a new `packages/city-frontend/src/city/<COMPONENT>/<COMPONENT>.yaml` file instead, where `<COMPONENT>` is the name of the component you've created.
...
Some test files use examples from each component’s `.yaml` file, for example `packages/city-frontend/src/city/components/button/button.yaml`. When you add or update these tests, you can use the existing examples or add new ones.
...
Create the following files in the `packages/city-frontend/src/city/components` folder:
...
You can use the existing files in the `packages/city-frontend/src/city/components` folder as templates for your new files.

### If you changed or added to a component

In the `packages/city-frontend/src/city/components` folder, update or add tests to:
...
For example, if you updated a mixin in [`packages/city-frontend/src/city/helpers/_colour.scss`](/packages/city-frontend/src/city/helpers/_colour.scss), update or add tests in [`packages/city-frontend/src/city/helpers/colour.test.js`](/packages/city-frontend/src/city/helpers/colour.test.js).
...
2. Run `npm test -- -u packages/city-frontend/src/city/components/<COMPONENT>` to update the snapshot test with the new markup.
3. Commit the updated file in the `/packages/city-frontend/src/city/components/<COMPONENT>/__snapshots__/` folder.
